 ...
 * ```
 * var content = Content.Create({ DisplayName: 'My folder' }, ContentTypes.Folder, repository);
 * ```
...
export class Content<T extends IContentOptions = IContentOptions> {
    ...
    */
     ...
     * ```ts
     * var content = Content.Create({ DisplayName: 'My folder' }, ContentTypes.Folder, repository); // content is an instance of the ContentTypes.Folder with the DisplayName 'My folder'
     * ```
     */
