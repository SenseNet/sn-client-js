...
(() => __awaiter(this, void 0, void 0, function* () {
    ...
    let reader = new snconfig_1.SnConfigReader(pathHelper.PackageRootPath);
    yield reader.ReadConfigFile();
    let cfg = yield reader.ValidateAsync('RepositoryUrl', 'UserName', 'Password');
