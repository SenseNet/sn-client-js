...
describe('ODataApi', () => {
    ...
    it('requests to create a Content and returns an Observable object', function () {
        let observable = service.Contents.Create('/workspace/project', { Id: 1, Type: 'Article', DisplayName: 'Article' }, SN_1.Content);
    ...
    it('requests to post a created a Content and returns an Observable object', function () {
        let content = new SN_1.Content({ Name: 'alma' }, service);
        let observable = service.Contents.Post('/workspace/project', content, SN_1.Content);
        expect(observable).to.be.instanceof(rxjs_1.Observable);
    });
