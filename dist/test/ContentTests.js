...
describe('Content', () => {
    ...
    describe('#Load()', () => {
        it('should return an Observable object', function () {
            expect(typeof Content_1.Content.Load('/workspace/project')).to.eq('object');
        });
    });
    describe('#Load()', () => {
        it('should return an Observable object', function () {
            expect(typeof Content_1.Content.Load(111)).to.eq('object');
        });
    });
    describe('#Load()', () => {
        it('should return an Observable object', function () {
            expect(typeof Content_1.Content.Load(111, { select: 'DisplayName' })).to.eq('object');
        });
    });
    ...
    describe('#Upload()', () => {
        let c = Content_1.Content.Create('Article', { Id: 1, Path: 'https://daily.demo.sensenet.com/lorem' });
        it('should return an Observable object', function () {
