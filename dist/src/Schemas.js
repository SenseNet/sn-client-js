...
function ContentTypeCTD() {
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.IntegerFieldSetting({
        name: 'Id',
        displayName: 'Id',
        description: 'A unique ID for the Content.',
        readOnly: true,
        compulsory: false,
        visibleBrowse: SN_1.FieldSettings.FieldVisibility.Hide,
        visibleEdit: SN_1.FieldSettings.FieldVisibility.Hide,
        visibleNew: SN_1.FieldSettings.FieldVisibility.Hide,
        defaultOrder: 0
    }));
    schema.FieldSettings.push(new SN_1.FieldSettings.IntegerFieldSetting({
        name: 'ParentId',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.ShortTextFieldSetting({
        name: 'Name',
        displayName: 'Uri name',
        readOnly: false,
        compulsory: true,
        visibleBrowse: SN_1.FieldSettings.FieldVisibility.Show,
        visibleEdit: SN_1.FieldSettings.FieldVisibility.Show,
        visibleNew: SN_1.FieldSettings.FieldVisibility.Show,
        defaultOrder: 0
    }));
    schema.FieldSettings.push(new SN_1.FieldSettings.IntegerFieldSetting({
        name: 'CreatedById',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.NullFieldSetting({
        name: 'Version',
        displayName: 'Version',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.LongTextFieldSetting({
        name: 'Description',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.ReferenceFieldSetting({
        name: 'CreatedBy',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.DateTimeFieldSetting({
        dateTimeMode: SN_1.FieldSettings.DateTimeMode.DateAndTime,
        name: 'CreationDate',
...
exports.ContentTypeCTD = ContentTypeCTD;
function GenericContentCTD() {
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.NullFieldSetting({
        ...
        readOnly: true,
        compulsory: false,
        visibleBrowse: SN_1.FieldSettings.FieldVisibility.Advanced,
        visibleEdit: SN_1.FieldSettings.FieldVisibility.Advanced,
        visibleNew: SN_1.FieldSettings.FieldVisibility.Advanced,
        defaultOrder: 0
    }));
    schema.FieldSettings.push(new SN_1.FieldSettings.ShortTextFieldSetting({
        name: 'Path',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.ChoiceFieldSetting({
        ...
        displayChoice: SN_1.FieldSettings.DisplayChoice.DropDown,
        enumTypeName: '',
        name: 'VersioningMode',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.RatingFieldSetting({
        range: 5,
        split: 1,
        name: 'Rate',
        displayName: 'Rate',
...
exports.GenericContentCTD = GenericContentCTD;
...
exports.ContentLinkCTD = ContentLinkCTD;
function FileCTD() {
    let options = {
...
exports.DynamicJsonContentCTD = DynamicJsonContentCTD;
...
exports.ExecutableFileCTD = ExecutableFileCTD;
...
exports.HtmlTemplateCTD = HtmlTemplateCTD;
function ImageCTD() {
    let options = {
...
exports.PreviewImageCTD = PreviewImageCTD;
...
exports.SettingsCTD = SettingsCTD;
...
exports.IndexingSettingsCTD = IndexingSettingsCTD;
...
exports.LoggingSettingsCTD = LoggingSettingsCTD;
...
exports.PortalSettingsCTD = PortalSettingsCTD;
...
exports.SystemFileCTD = SystemFileCTD;
...
exports.ResourceCTD = ResourceCTD;
function FolderCTD() {
    let options = {
...
exports.ContentListCTD = ContentListCTD;
function AspectCTD() {
    let options = {
...
exports.ItemListCTD = ItemListCTD;
...
exports.CustomListCTD = CustomListCTD;
...
exports.MemoListCTD = MemoListCTD;
...
exports.TaskListCTD = TaskListCTD;
function LibraryCTD() {
    let options = {
...
exports.DocumentLibraryCTD = DocumentLibraryCTD;
...
exports.ImageLibraryCTD = ImageLibraryCTD;
function DeviceCTD() {
    let options = {
...
function EmailCTD() {
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.LongTextFieldSetting({
        textType: SN_1.FieldSettings.TextType.RichText,
        name: 'Body',
        displayName: 'Body',
...
exports.OrganizationalUnitCTD = OrganizationalUnitCTD;
...
exports.PortalRootCTD = PortalRootCTD;
...
exports.ProfileDomainCTD = ProfileDomainCTD;
...
exports.ProfilesCTD = ProfilesCTD;
...
exports.RuntimeContentContainerCTD = RuntimeContentContainerCTD;
function SitesCTD() {
    let options = {
...
exports.SmartFolderCTD = SmartFolderCTD;
...
exports.SystemFolderCTD = SystemFolderCTD;
...
exports.ResourcesCTD = ResourcesCTD;
...
exports.TrashBagCTD = TrashBagCTD;
...
exports.WorkspaceCTD = WorkspaceCTD;
function SiteCTD() {
    let options = {
...
exports.TrashBinCTD = TrashBinCTD;
...
exports.UserProfileCTD = UserProfileCTD;
function GroupCTD() {
    let options = {
...
exports.ListItemCTD = ListItemCTD;
...
exports.CustomListItemCTD = CustomListItemCTD;
function MemoCTD() {
    let options = {
...
function QueryCTD() {
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.ChoiceFieldSetting({
        ...
        displayChoice: SN_1.FieldSettings.DisplayChoice.RadioButtons,
        enumTypeName: '',
        name: 'QueryType',
...
function UserCTD() {
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.CaptchaFieldSetting({
        name: 'Captcha',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.DateTimeFieldSetting({
        dateTimeMode: SN_1.FieldSettings.DateTimeMode.Date,
        name: 'BirthDate',
    ...
    schema.FieldSettings.push(new SN_1.FieldSettings.LongTextFieldSetting({
        textType: SN_1.FieldSettings.TextType.LongText,
        name: 'Education',
